...
internal class KeycloakClientAssignUserGroupsCommandHandler(IHttpClientFactory httpClientFactory,
                                                            ISender sender,
                                                            IAppSettingsKeyManagement appSettingsKeyManagement)
    : ICommandHandler<KeycloakClientAssignUserGroupsCommand, KeycloakClientAssignUserGroupsResult>
{
    public async Task<KeycloakClientAssignUserGroupsResult> Handle(KeycloakClientAssignUserGroupsCommand command, CancellationToken cancellationToken)
    {
        ...
        return new KeycloakClientAssignUserGroupsResult(true);
    }
}