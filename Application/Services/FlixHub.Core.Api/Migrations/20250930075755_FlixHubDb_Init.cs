        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OriginalLanguage = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: true, comment: "ISO 639-1 language code."),
                    ReleaseDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true, comment: "Movie: release_date / TV: first_air_date."),
                    Status = table.Column<string>(type: "varchar(50)", nullable: true, comment: "Release status: Released, Ended, Returning Series."),
                    Country = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: true, comment: "ISO 3166-1 country code."),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AirDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true, comment: "First air date of the season."),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AirDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true, comment: "Air date of the episode."),
